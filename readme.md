...
Для каждой ноты из списка, генерируем дочерний вейвлет ![formula](https://render.githubusercontent.com/render/math?math=modifier_{scale}), где *scale* - положение относительно базовой ноты. 
